...
struct MockData {
    ...
    static let representativeLesson = RepresentativeLesson(date: .init(timeIntervalSinceNow: 3600), lesson: 5, room: "A10", newRoom: "A11", note: "Raumänderung", subject: subject, normalTeacher: "PST")
    static let representativeLesson2 = RepresentativeLesson(date: .init(timeIntervalSinceNow: 10000), lesson: 2, room: "PR1", newRoom: nil, note: "EVA", subject: subject2, normalTeacher: "PR1")
