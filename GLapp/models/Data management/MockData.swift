...
struct MockData {
    static let subject = Subject(className: "M-LK2", subjectType: "LK", teacher: "PST")
    static let subject2 = Subject(className: "PH-LK1", subjectType: "LK", teacher: "SEN")
    static let subject3 = Subject(className: "EK-GK2", subjectType: "GKM", teacher: "BUS")
    static let subject4 = Subject(className: "PSE", subjectType: "PSE", teacher: "BLN", subjectName: "PSE")
