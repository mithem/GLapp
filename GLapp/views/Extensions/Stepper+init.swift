...
extension Stepper {
    init<ValueType>(settingsValue: SettingsValueStrideable<ValueType>, label: @escaping () -> String) where ValueType: Strideable, ValueType.Stride == ValueType, Label == Text {
    ...
    init<ValueType>(settingsValue key: KeyPath<SettingsStore, SettingsValueStrideable<ValueType>>, label: @escaping () -> String) where ValueType: Strideable, ValueType.Stride == ValueType, Label == Text {
